          ...
          <div className="flex items-center justify-between h-16 px-4">
            ...
            <div className="hidden md:block flex-1 px-4 max-w-md">
              <div className="relative">
                ...
                <input
                  type="text"
                  className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md leading-5 bg-background text-foreground placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                  placeholder="Search..."
                />
              </div>
            </div>
